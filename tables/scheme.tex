...
\cmidrule{3-3}\cmidrule{4-4}
 &  & \multicolumn{2}{l}{\textit{(\textsf{name}, \textsf{qualified\_\textsf{name}} and \textsf{file\_path})}} \\
\cmidrule{2-2}\cmidrule{3-3}\cmidrule{4-4}
...
\cmidrule{2-2}\cmidrule{3-3}\cmidrule{4-4}\cmidrule{5-5}
 & \multirow{2}[4]{*}{Parameter} & \multirow{2}[4]{*}{\textsf{TAKES}} & \multirow{2}[4]{*}{\textsf{Function} \textsf{TAKES} \textsf{Class}} & \textsf{param\_\textsf{name}} \\
\cmidrule{5-5}
